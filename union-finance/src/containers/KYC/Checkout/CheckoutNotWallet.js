...
const CheckoutNotWallet = () => {
  ...
  const { privacy, access } = useStyles();
      ...
      <Grid container justify="center" style={{ marginTop: 60 }}>
        <Grid item xs={8}>
          <Typography component="div" variant="body1" color="textPrimary">
            This Checkout requires access to your wallet.
          </Typography>
          <Typography component="div" variant="body1" color="textPrimary">
            Please contact{' '}
            <Box
            ...
            if you are authorized or authorize access{' '}
            <Box class={access} component="span" onClick={handleBackBtn}></Box>
            here to your MetaMask accounts to continue.
          </Typography>
        </Grid>
      </Grid>
    </Container>
